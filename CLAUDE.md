...
internal/
  ...
  services/
    ...
    serviceaccounts/ — anthropic_service_account resource (Beta managed-agents API; WIF non-human identity, org:admin OAuth bearer only)
```
